...
namespace Foosbot.DecisionUnit.Core
{
    ...
    /// Decision Tree Class
    /// </summary>
    public class FullDecisionTree : IDecisionTree
    {
        #region Constants

        private readonly int BALL_RADIUS;
        private readonly int TABLE_WIDTH;
        private readonly int PLAYER_WIDTH;
        ...
        /// </summary>
        private IDecisionHelper _helper;
        ...
        public RodAction Decide(IRod rod, BallCoordinates bfc)
        {
        ...
        private int CalculateNewRodCoordinate(IRod rod, int respondingPlayer, BallCoordinates bfc, eLinearMove desiredLinearMove)
        {
            //Define actual desired rod coordinate to move to
